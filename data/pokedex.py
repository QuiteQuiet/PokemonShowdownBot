Pokedex = {
	...
	"Pikachu": {
		...
		"otherFormes": ["pikachucosplay", "pikachurockstar", "pikachubelle", "pikachupopstar", "pikachuphd", "pikachulibre", "pikachuoriginal", "pikachuhoenn", "pikachusinnoh", "pikachuunova", "pikachukalos", "pikachualola", "pikachupartner", "pikachustarter", "pikachugmax", "pikachuworld"],
	},
	"Pikachu-Cosplay": {
		"num": 25,
	...
	"Lycanroc": {
		...
		"abilities": {"0": "Keen Eye", "1": "Sand Rush", "H": "Steadfast", "S": "Own Tempo"},
		"heightm": 0.8,
		"weightkg": 25,
		"color": "Brown",
		"prevo": "rockruff",
