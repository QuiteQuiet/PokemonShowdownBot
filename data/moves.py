from plugins.battling.battleCallbacks import *
...
Moves = {
	...
	"alluringvoice": {
		...
		"pp": 10,
		"priority": 0,
		"flags": {"protect", "mirror", "sound", "bypasssub"},
		"secondary": {
			"chance": 100,
		},
		"target": "normal",
	...
	"aquastep": {
		...
		"pp": 10,
		"priority": 0,
		"flags": {"contact", "protect", "mirror", "dance"},
		"secondary": {
			"chance": 100,
			"self": {
				"boosts": {
	...
	"babydolleyes": {
		...
		"pp": 30,
		"priority": 1,
		"flags": {"protect", "reflectable", "mirror", "mystery"},
		"boosts": {
			"atk": -1,
		},
		"secondary": None,
	...
	"barbbarrage": {
		...
		"priority": 0,
		"flags": {"protect", "mirror"},
		"modifyBasePower": targetPoisonBoosted,
		"secondary": {
			"chance": 50,
			"status": 'psn',
		},
	...
	"behemothbash": {
		...
		"id": "behemothbash",
		"name": "Behemoth Bash",
		"modifyBasePower": doublesAgainstDynamax,
		"pp": 5,
		"priority": 0,
		"flags": {"contact", "protect", "mirror"},
		"secondary": None,
	...
	"bestow": {
		...
		"pp": 15,
		"priority": 0,
		"flags": {"mirror", "authentic", "mystery"},
		"secondary": None,
		"target": "normal",
		"type": "Normal",
		"zMoveBoost": {"spe": 2},
	...
	"bitterblade": {
		...
		"pp": 10,
		"priority": 0,
		"flags": {"contact", "protect", "mirror", "heal", "slicing"},
		"drain": [1, 2],
		"secondary": None,
		"target": "normal",
		"type": "Fire",
    ...
    "bloodmoon": {
		...
		"pp": 5,
		"priority": 0,
		"flags": {"protect", "mirror", "cantusetwice"},
		"secondary": None,
		"target": "normal",
		"type": "Normal",
	},
	...
	"bodypress": {
		...
		"priority": 0,
		"flags": {"contact", "protect", "mirror"},
		"useAlternativeOffensiveStat": "def",
		"secondary": None,
		"target": "normal",
		"type": "Fighting",
	},
	...
	"boltbeak": {
		...
		"accuracy": 100,
		"basePower": 85,
		"modifyBasePower": doublesIfMovingFirst,
		"category": "Physical",
	...
	"collisioncourse": {
		...
		"priority": 0,
		"flags": {"contact", "protect", "mirror"},
        'modifyEffectiveness': extraSuperEffective,
		"secondary": None,
		"target": "normal",
		"type": "Fighting",
		"contestType": "Tough",
	...
	"comeuppance": {
		...
		"pp": 10,
		"priority": 0,
		"flags": {"contact", "protect", "mirror", "failmefirst"},
		"secondary": None,
		"target": "scripted",
		"type": "Dark",
		"contestType": "Cool",
	...
	"dragonenergy": {
		...
		"basePower": 150,
		"category": "Special",
		"modifyBasePower": variableBasedOnHpPercentageRemaining,
        "id": "dragonenergy",
		"name": "Dragon Energy",
		"pp": 5,
		"priority": 0,
	...
	"featherdance": {
		...
		"pp": 15,
		"priority": 0,
		"flags": {"protect", "reflectable", "mirror", "mystery", "dance"},
		"boosts": {
			"atk": -2,
		},
		"secondary": None,
	...
	"flail": {
		...
		"id": "flail",
		"name": "Flail",
		"modifyBasePower": variableBasedOnHpRatioRemaining,
		"pp": 15,
		"priority": 0,
		"flags": {"contact", "protect", "mirror"},
		"secondary": None,
	...
	"floralhealing": {
		...
		"pp": 10,
		"priority": 0,
		"flags": {"protect", "reflectable", "heal", "mystery"},
		"secondary": None,
		"target": "normal",
		"type": "Fairy",
		"zMoveEffect": 'clearnegativeboost',
	...
	"grassknot": {
		...
		"accuracy": 100,
		"basePower": 0,
		"calculateBasePower": absoluteWeightBasedBasePower,
		"category": "Special",
	...
	"guardswap": {
		...
		"pp": 10,
		"priority": 0,
		"flags": {"protect", "mirror", "authentic", "mystery"},
		"secondary": None,
		"target": "normal",
		"type": "Psychic",
		"zMoveBoost": {"spe": 1},
	...
	"hardpress": {
		...
		"accuracy": 100,
		"basePower": 0,
		"modifyBasePower": variableBasedOnTargetHpRemaining,
		"category": "Physical",
		"id": "hardpress",
		"name": "Hard Press",
		"pp": 10,
	...
	"healpulse": {
		...
		"pp": 10,
		"priority": 0,
		"flags": {"protect", "pulse", "reflectable", "distance", "heal", "mystery"},
		"secondary": None,
		"target": "any",
		"type": "Psychic",
		"zMoveEffect": 'clearnegativeboost',
	...
	"hex": {
		...
		"id": "hex",
		"isViable": True,
		"modifyBasePower": targetStatusBoosted,
		"name": "Hex",
		"pp": 10,
		"priority": 0,
		"flags": {"protect", "mirror"},
	...
	"instruct": {
		...
		"pp": 15,
		"priority": 0,
		"flags": {"protect", "authentic", "mystery"},
		"secondary": None,
		"target": "normal",
		"type": "Psychic",
		"zMoveBoost": {"spa": 1},
	...
	"junglehealing": {
		...
		"pp": 10,
		"priority": 0,
		"flags": {"distance", "heal", "authentic", "mystery"},
		"heal": [1, 4],
		"secondary": None,
		"target": "allies",
		"type": "Grass",
	...
	"lastrespects": {
		...
		"name": "Last Respects",
        "id": "lastrespects",
        'modifyBasePower': increaseIfPartyFainted,
		"pp": 10,
		"priority": 0,
		"flags": {"protect", "mirror"},
		"secondary": None,
	...
	"metalsound": {
		...
		"pp": 40,
		"priority": 0,
		"flags": {"protect", "reflectable", "mirror", "sound", "authentic", "mystery"},
		"boosts": {
			"spd": -2,
		},
		"secondary": None,
	...
	"odorsleuth": {
		...
		"pp": 40,
		"priority": 0,
		"flags": {"protect", "reflectable", "mirror", "authentic", "mystery"},
		"volatileStatus": 'foresight',
		"secondary": None,
		"target": "normal",
		"type": "Normal",
	...
	"perishsong": {
		...
		"pp": 5,
		"priority": 0,
		"flags": {"sound", "distance", "authentic"},
		"secondary": None,
		"target": "all",
		"type": "Normal",
		"zMoveEffect": 'clearnegativeboost',
	...
	"poltergeist": {
		...
		"id": "poltergeist",
		"modifyBasePower": requiresOpponentItem,
		"name": "Poltergeist",
		"pp": 5,
		"priority": 0,
		"flags": {"protect", "mirror"},
	...
	"purify": {
		...
		"pp": 20,
		"priority": 0,
		"flags": {"protect", "reflectable", "heal"},
		"secondary": None,
		"target": "normal",
		"type": "Poison",
		"zMoveBoost": {"atk": 1, "def": 1, "spa": 1, "spd": 1, "spe": 1},
	...
	"roar": {
		...
		"pp": 20,
		"priority": -6,
		"flags": {"reflectable", "mirror", "sound", "authentic", "mystery"},
		"forceSwitch": True,
		"secondary": None,
		"target": "normal",
		"type": "Normal",
	...
	"spectralthief": {
		...
		"pp": 10,
		"priority": 0,
		"flags": {"contact", "protect", "mirror", "authentic"},
		"stealsBoosts": True,
		"secondary": None,
		"target": "normal",
		"type": "Ghost",
	...
	"spotlight": {
		...
		"pp": 15,
		"priority": 3,
		"flags": {"protect", "reflectable", "mystery"},
	...
	"strengthsap": {
		...
		"pp": 10,
		"priority": 0,
		"flags": {"protect", "reflectable", "mirror", "heal"},
		"secondary": None,
		"target": "normal",
		"type": "Grass",
		"zMoveBoost": {"def": 1},
	...
	"telekinesis": {
		...
		"pp": 15,
		"priority": 0,
		"flags": {"protect", "reflectable", "mirror", "gravity", "mystery"},
	...
	"terablast": {
		...
		"pp": 10,
		"priority": 0,
		"flags": {"protect", "mirror", "mustpressure"},
		"secondary": None,
		"target": "normal",
		"type": "Normal",
	},
	"terastarstorm": {
		...
		"pp": 5,
		"priority": 0,
		"flags": {"protect", "mirror", "noassist", "failcopycat", "failmimic"},
		"secondary": None,
		"target": "normal",
		"type": "Normal",
	},
	...
	"whirlwind": {
		...
		"pp": 20,
		"priority": -6,
		"flags": {"reflectable", "mirror", "authentic", "mystery"},
		"forceSwitch": True,
		"secondary": None,
		"target": "normal",
		"type": "Normal",
